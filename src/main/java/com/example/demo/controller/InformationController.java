...
public class InformationController {
    ...
    public String bannedUser(@RequestParam("id") String id){
    ...
    @GetMapping("/api/auth/login/{id}/{password}")

    public List login(@PathVariable("id") String id,@PathVariable("password") String password){
